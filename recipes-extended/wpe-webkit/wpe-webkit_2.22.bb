...
DEPENDS_append = " wpe-backend atk tts rdkat libepoxy libgcrypt rsync-native"
...
#SRC_URI += "file://2.22/0005-comcast-set-local-storage-quota-to-100K.patch"
...
# SRC_URI += "file://2.22/0012-comcast-DelayedAudio-test.patch"
SRC_URI += "file://2.22/0013-comcast-Revert-Change-antialiasing-policy-on-the-accelerated.patch"
SRC_URI += "file://2.22/0014-Comcast-Youtube-improvements.patch"
# SRC_URI += "file://2.22/0015-comcast-downscale-jpeg-images.patch"
...
SRC_URI += "file://2.22/0019-comcast-EME-add-SVP-support.patch"
...
SRC_URI += "file://2.22/0024-comcast-add-EAC3-support.patch"
#SRC_URI += "file://2.22/0025-comcast-Prioritize-ping-web-process-messages.patch"
SRC_URI += "file://2.22/0027-comcast-Gap-addjustment-based-on-first-pts.patch"
SRC_URI += "file://2.22/0028-comcast-youtube-progress-logs.patch"
...
# SRC_URI += "file://2.22/0034-Defer-seek-complition-until-it-is-actually-finished.patch"
...
SRC_URI += "file://2.22/0037-fixes-for-Youtube-encrypted-playback.patch"
...
SRC_URI += "file://2.22/0040-Don-t-send-caps-out-of-flow-in-already-configured-stream.patch"
...
#SRC_URI += "file://2.22/0056-Shared-JSC-build.patch"
SRC_URI += "file://2.22/0057-Reduce-the-impact-of-dev-logs.patch"
SRC_URI += "file://2.22/0058-Fix-crash-due-to-infinite-recursion-on-seek.patch"
SRC_URI += "file://2.22/0059-Revert-WPE-SoupNetworkSession.patch"
SRC_URI += "file://2.22/0060-Fix-dispatching-of-progress-events-in-paused-state.patch"
SRC_URI += "file://2.22/0061-Increase-parser-time-limit.patch"
SRC_URI += "file://2.22/0063-Fix-holepunching-after-re-parenting-video-layer.patch"
...
SRC_URI += "file://2.22/0069-Reset-m_isEndReached-on-unmarkEndOfStream.patch"
...
SRC_URI += "file://2.22/0073-Implement-hasPendingActivity-for-MediaKeySession.patch"
SRC_URI += "file://2.22/0074-Increase-clear-SB-limits-for-4K-devices.patch"
...
SRC_URI += "file://2.22/0084-Handle-gst-pad-error-as-format-error.patch"
SRC_URI += "file://2.22/0084-Propagate-parsing-errors-to-MSE-SourceBuffer.patch"
SRC_URI += "file://2.22/0085-Detect-DolbyVision.patch"
SRC_URI += "file://2.22/0086-MSE-update-m_bufferFull-flag-when-evicted-enough.patch"
SRC_URI += "file://2.22/0087-MSE-SourceBuffer-Fix-creating-float-PTS-DTS-when-div.patch"
SRC_URI += "file://2.22/0087-MSE-SourceBuffer-Fix-removal-of-paddings-from-buffer.patch"
...
SRC_URI += "file://2.22/0090-Add-isEmpty-API-to-PODRedBlackTree.patch"
SRC_URI += "file://2.22/0091-MSE-Make-SourceBuffer-evictCodedFrames-less-aggressive.patch"
...
SRC_URI += "file://2.22/0094-Fix-occasional-HDR-video-playback-stalls-after-seek.patch"
...
#SRC_URI += "file://2.22/0169-comcast-Fix-dispatching-of-encrypted-event.patch"
SRC_URI += "file://2.22/0174-XRE-14411-RDK-AT-handles-all-types-of-headers.patch"
SRC_URI += "file://2.22/0178-XRE-14630-App-throwing-Error-when-an-error-occurred.patch"
...
#SRC_URI += "file://2.22/0186-Fix-build-of-wpe-test-bundle.patch"
...
SRC_URI += "file://2.22/0199-webrtc-improvements-for-xcloudgames.patch"
SRC_URI += "file://2.22/0200-Validate-allowScriptsToCloseWindows-exclusively.patch"
SRC_URI += "file://2.22/0202-ARMv7-JSC-Conservative-GC-is-not-considering-r7-as-a.patch"
...
SRC_URI += "file://2.22/0207-uncommented-getcookies2-call-to-get-the-cookies-usin.patch"
SRC_URI += "file://2.22/0208-XRE-16048-Playing-Event-is-not-in-order.patch"
SRC_URI += "file://2.22/0210-Fix-crash-on-dynamic-change-of-non-composited-webgl-.patch"
SRC_URI += "file://2.22/0210-REGRESSION-r230950-GTK-WebKit-CoordinatedBackingStor.patch"
SRC_URI += "file://2.22/0211-Fix-wpe-view-backend-leak.patch"
...
SRC_URI += "file://2.22/0214-fixed-crash-in-XMLHttpRequest-called-from-worker.patch"
SRC_URI += "file://2.22/0216-Accessibility.patch"
...
SRC_URI += "file://2.22/0218-Fix-detection-of-EOS-in-MSE-playback.patch"
...
SRC_URI += "file://2.22/0221-comcast-fix-use-after-free-on-dynamic-switch-from-non-compos.patch"
...
SRC_URI += "file://2.22/0224-Fix-ASAN-build.patch"
SRC_URI += "file://2.22/0225-Fix-memory-pressure-poller-thread-leak.patch"
SRC_URI += "file://2.22/0226-Use-process-status-to-compute-memory-footprint.patch"
SRC_URI += "file://2.22/0227-Add-non-synchronous-pressure-notifications.patch"
...
SRC_URI += "file://2.22/0230-Backport-CoordinatedGraphicsLayer-setNeedsDisplayInR.patch"
SRC_URI += "file://2.22/0231-ScalableImageDecoder-avoid-unnecessarily-decoding-im.patch"
SRC_URI += "file://2.22/0232-Disable-endcoded-data-replacement-for-images-with-as.patch"
SRC_URI += "file://2.22/0233-Don-t-update-content-buffers-in-non-composited-webgl.patch"
...
SRC_URI += "file://2.22/0236-Revert-scheduleNotifyAboutPlaying-changes.patch"
...
SRC_URI += "file://2.22/0241-Fix-false-positive-stalled-event-iff-MSE-is-used.patch"
...
SRC_URI += "file://2.22/0245-REGRESSION-r257905-Mac-wk2-Debug-ASSERTION-FAILED-m_.patch"
SRC_URI += "file://2.22/0246-Source-WebCore.patch"
SRC_URI += "file://2.22/0247-Fix-DFG-doesGC-for-CompareEq-Less-LessEq-Greater-Gre.patch"
SRC_URI += "file://2.22/0248-Fix-DFG-s-doesGC-for-a-few-more-nodes.patch"
SRC_URI += "file://2.22/0249-DFG-s-doesGC-is-incorrect-about-the-SameValue-node-s.patch"
SRC_URI += "file://2.22/0250-Array-unshift-shift-should-not-race-against-the-AI-i.patch"
SRC_URI += "file://2.22/0260-Synchronous-media-query-evaluation-could-destroy-cur.patch"
