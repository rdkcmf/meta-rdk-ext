...
SRCREV = "03dc152b72d5aa9c4e74c418438d6b2eb06a8e8d"
...
SRC_URI += "file://2.22.1/0014-Comcast-Youtube-improvements.patch"
...
SRC_URI += "file://2.22.1/0097-Add-MediaError.message-and-clarify-decryption-errors.patch"
...
#SRC_URI += "file://2.22/0213-Playready4-Amazon4K-workaround.patch"
...
#SRC_URI += "file://2.22.1/0215-added-width-and-height-to-decrypt-calls.patch"
...
SRC_URI += "file://2.22.1/0225-Revert-GStreamer-EME-Lock-while-CDM-updates-keys.patch"
SRC_URI += "file://2.22.1/0225-Fix-memory-pressure-poller-thread-leak.patch"
SRC_URI += "file://2.22.1/0226-Use-process-status-to-compute-memory-footprint.patch"
SRC_URI += "file://2.22.1/0227-Add-non-synchronous-pressure-notifications.patch"
...
SRC_URI += "file://2.22.1/0242-Fix-timeout-during-browser-exit.patch"
