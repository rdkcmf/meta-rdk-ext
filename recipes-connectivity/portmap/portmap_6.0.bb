...
SRC_URI_append_dunfell = " file://0001-member-name-update-to-sin6_port-in-sockaddr_in6.patch"
...
DEPENDS_append_dunfell = " libtirpc"
CFLAGS_append_dunfell = " -I${PKG_CONFIG_SYSROOT_DIR}/usr/include/tirpc"
LDFLAGS_prepend_dunfell = " -ltirpc "
